...
function vowelCounter(word) {
  ...
  let result = word.match(/[aeiou]/ig);
  let count = result.length;
  return count;
}

console.log("Vowel Counter", vowelCounter("victor"));
